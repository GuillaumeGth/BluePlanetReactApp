...
return <InstagramContainer>
      ...
      {data.data.map(function(e){
        ...
        if(e.type === 'video'){
          return (<InstagramUnit key={e.id} caption={e.caption} type={e.type} src={e.videos.standard_resolution.url} alt={e.caption} media={e.videos} fullObject={e} />);        
        }
        else{
          return (<InstagramUnit 
            key={e.id} 
            caption={e.caption} 
            type={e.type} 
